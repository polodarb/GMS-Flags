...
fun SettingsScreen(
    ...
    Scaffold(
        ...
        Column(modifier = Modifier.padding(it)) {
            Column {
                SettingsItem(R.drawable.ic_reset, "Reset flags", "Reset all overridden flags", { })
                SettingsItem(R.drawable.ic_reset_saved, "Reset saved", "Reset all saved packages or flags", { })
